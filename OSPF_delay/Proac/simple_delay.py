...
class simple_Delay(app_manager.RyuApp):
    ...
    def write_dijkstra_paths(self):
        ...
        for src in self.awareness.switches:
            for dst in self.awareness.switches:
                if src != dst:
                    paths[src][dst] = self.dijkstra(self.delay_dict, src, dst, visited=[], distances={}, predecessors={})
        
        with open('/home/controlador/ryu/ryu/app/OSPF_delay/Proac/paths_delay.json','w') as json_file:
            json.dump(paths, json_file, indent=2)
        
        total_time = time.time() - time_init
        # print(total_time)
        with open('/home/controlador/ryu/ryu/app/OSPF_delay/Proac/times.txt','a') as txt_file:
    ...
    def get_paths_dijkstra(self):
        file_dijkstra = '/home/controlador/ryu/ryu/app/OSPF_delay/Proac/paths_delay.json'
    ...
    def get_paths_base(self):
        file_base = '/home/controlador/ryu/ryu/app/OSPF_delay/Proac/paths_weight.json'
    ...
    def calc_stretch(self):
        ...
        with open('/home/controlador/ryu/ryu/app/OSPF_delay/Proac/stretch/'+str(self.count)+'_stretch.csv','wb') as csvfile:
